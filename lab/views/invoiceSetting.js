...
const InvoiceHeader = ({ invoice, employees }) => {
  ...
  //             <div className="size1">
  //               <p className="title">{employees[0].jop}</p>
  //               <p className="namet">{employees[0].name}</p>
  //               <p className="certificate">{employees[0].jop_en}</p>
  //             </div>
  ...
  //           <div className="left col-4" data-hash={employees[1].hash}>
  //             <div className="size1">
  //               <p className="title">{employees[1].jop}</p>
  //               <p className="namet">{employees[1].name}</p>
  //               <p className="certificate">{employees[1].jop_en}</p>
  //             </div>

  //             <div className="size2"></div>
  //           </div>

  //           <div className="logo col-4 p-2" data-hash={"logo"}>
  //             <img src={invoice.logo} alt="" />
  //           </div>
  //           <div className="right col-4" data-hash={employees[0].hash}>
  //             <div className="size1">
  //               <p className="title">{employees[0].jop}</p>
  //               <p className="namet">{employees[0].name}</p>
  //               <p className="certificate">{employees[0].jop_en}</p>
            ...
            return (
              ...
              >
                <div className="size1">
                  ...
                  <p className="namet">{employee.name}</p>
