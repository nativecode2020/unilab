...
let allData = run(`select name, birth, gender, phone from lab_patient where hash='${patientHash}';
                    select
                    ...
                    SELECT name,jop, jop_en from lab_invoice_worker where lab_hash='${localStorage.getItem('lab_hash')} and is_available=1' and isdeleted=0 limit 2;`);
...
visitsData.forEach(visit => {
    ...
    <tr onclick="visitDetail('${visit.hash}');fireSwalWithoutConfirm(showVisit, '${visit.hash}')">
