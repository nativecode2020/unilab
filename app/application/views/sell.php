...
var id=0;
    ...
    {
    //alert("dddd");
    $("#tb").append('<input class="multisteps-form__input form-control" id="pic'+id+'" type="file" name="files[]" multiple  accept="image/*" capture="camera" />');
    $('#pic'+id).click();
    id++;
    }
</script>
            ...
            <div class="row">
                <div class="col-12 col-lg-8 ml-auto mr-auto mb-4">
                    <div class="multisteps-form__progress">
                        <button class="multisteps-form__progress-btn js-active" type="button" title="User Info">Item image</button>
                        <button class="multisteps-form__progress-btn" type="button" title="Address">Item info</button>
                        <button class="multisteps-form__progress-btn" type="button" title="Category">Category</button>
                        <button class="multisteps-form__progress-btn" type="button" title="Order Info">Address</button>
                        <button class="multisteps-form__progress-btn" type="button" title="Comments">Price</button>
                    </div>
                </div>
            </div>
            <!--form panels-->
                ...
                <div class="col-12 col-lg-8 m-auto">
                    <form class="multisteps-form__form" action="<?php  echo site_url("Seller/add_post");?>" method="post" enctype="multipart/form-data" >
                            ...
                            <div class="multisteps-form__content">
                                <div class="form-row mt-4">
                                    <div class="col-12 col-sm-12">
                                        <a href="#" onclick="add_picture()" ><img src="<?php echo base_url(); ?>item_images/cam.png"   style="width:100%;height:90%;"></img></a>
                                        <table id="tb">
                        ...
                        <div class="multisteps-form__panel shadow p-4 rounded bg-white" data-animation="scaleIn">
                         ...
                         <!--single form panel-->
                         <div class="multisteps-form__panel shadow p-4 rounded bg-white" data-animation="scaleIn">
                            <h3 class="multisteps-form__title">Category</h3>
                            <div class="multisteps-form__content">
                                <div class="form-row mt-4">
                                <select class="multisteps-form__input form-control" name="category">
                                       <?php
                                        foreach($category as $c)
                                        {
                                            print'<option value="'.$c["hash"].'">'.$c["cat_name"].'</option>';
                                        }
                                        ?>
                                        </select>
                                </div>
                                ...
                                <select class="multisteps-form__input form-control" name="status">
                                       <?php
                                        foreach($status as $c)
                                        {
                                            print'<option value="'.$c["hash"].'">'.$c["item_status"].'</option>';
                                        }
                                        ?>
                                        </select>     
                                </div>
                                    ...
                                    <div class="col-12 col-md-12 mt-4">
                                        <div class="card shadow-sm">
                                            <div class="card-body">
                                                ...
                                                <input type="hidden" name="user_info" value="<?php echo $user_hash; ?>" />
                        ...
                        <div class="multisteps-form__panel shadow p-4 rounded bg-white" data-animation="scaleIn">
                            ...
                            <div class="multisteps-form__content">
                                ...
                                <div class="form-row mt-4">
                                        <select class="multisteps-form__input form-control" name="currency">
                                       <?php
                                        foreach($currency as $c)
                                        {
                                            print'<option value="'.$c["hash"].'">'.$c["currency_name"].'</option>';
                                        }
                                        ?>
                                        </select>
