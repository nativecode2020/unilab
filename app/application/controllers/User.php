...
class User extends CI_Controller
{
    ...
    public function getUsers()
    {
        ...
        $packages = $this->User_model->getUsers($length, $start, $search);
        $total_rows = $this->User_model->record_count($search);
        $output = array(
            "draw" => $draw,
    ...
    public function getUsersByLab()
    {
        ...
        $start = intval($this->input->post("start"));
        $length = intval($this->input->post("length"));
        $hash = $this->input->post('lab_id');
        $packages = $this->User_model->getUsersByLab($length, $start, $search, $hash);
