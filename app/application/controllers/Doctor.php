...
class Doctor extends CI_Controller
{
    ...
    public function getDoctorForLab()
    {
        ...
        $packages = $this->Doctor_model->getDoctorForLAb($this->input->post('lab_id'), $length, $start, $search);
        $total_rows = $this->Doctor_model->record_count_for_lab($search);
        $output = array(
            "draw" => $draw,
