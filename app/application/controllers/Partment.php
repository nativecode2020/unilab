...
class Partment extends CI_Controller
{
    function __construct()
    {
        parent::__construct();
        $this->load->model('Menu_db');
        $this->load->model('Partment_model');
    ...
    public function getPartment()
    {
        ...
        $packages = $this->Partment_model->getPartment($length, $start, $search);
        $total_rows = $this->Partment_model->record_count($search);
        $output = array(
            "draw" => $draw,
